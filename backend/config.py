...
ANALYSIS_VERSION = os.getenv("ANALYSIS_VERSION", "5c-1")
...
EVIDENCE_PROBE_TIMEOUT_SECONDS = float(os.getenv("EVIDENCE_PROBE_TIMEOUT_SECONDS", "3"))
EVIDENCE_MAX_LINKS = max(1, int(os.getenv("EVIDENCE_MAX_LINKS", "24")))
EVIDENCE_MAX_WORKERS = max(1, int(os.getenv("EVIDENCE_MAX_WORKERS", "8")))
EVIDENCE_CONTENT_TIMEOUT_SECONDS = float(os.getenv("EVIDENCE_CONTENT_TIMEOUT_SECONDS", "4"))
EVIDENCE_CONTENT_MAX_LINKS = max(1, int(os.getenv("EVIDENCE_CONTENT_MAX_LINKS", "6")))
EVIDENCE_CONTENT_MAX_BYTES = max(65536, int(os.getenv("EVIDENCE_CONTENT_MAX_BYTES", "600000")))
